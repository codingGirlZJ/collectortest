...
public class CrawlerUtil_facebook_group extends BreadthCrawler {

	private Proxys proxys = new Proxys();

	public CrawlerUtil_facebook_group(String crawlPath, boolean autoParse, Proxys proxys) {
	...
	public void visit(Page page, CrawlDatums next) {
		...
		if (page.url().matches("https://www.facebook.com/groups/835169959849575")) {
	...
	public static void main(String[] args) throws Exception {
		...
		CrawlerUtil_facebook_group crawler = new CrawlerUtil_facebook_group("crawler", true, proxys);
		crawler.addSeed("https://www.facebook.com/groups/835169959849575");
